"""
Django settings example file. 
Copy this to settings.py and fill in the required values.
"""
...
SECRET_KEY = '@Tu5JD3MWvFhHrv'  # Change this to a secure random key!
...
# For production PostgreSQL database (uncomment and configure)
# DATABASES = {
#     'default': {
...
# For production, use whitelist instead:
